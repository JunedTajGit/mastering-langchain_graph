...
def as_retriever():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # basic retriever usage -> it return runnable
        ...
        # mmr => max marginal revelance
        # TODO: learn more on type of retriver
...
def exercise_vector_store_setup():
    ...
    queries = ["What's good for web development?", "Which language is safest?"]
