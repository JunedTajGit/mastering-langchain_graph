...
def embedding_caching():
    from langchain_classic.embeddings.cache import CacheBackedEmbeddings # By Dec 2026 this will be deprecated
    # from langchain.embeddings.base import CacheBackedEmbeddings -- Not working
    from langchain_classic.storage import LocalFileStore # By Dec 2026 this will be deprecated
    # from langchain_community.storage import LocalFileStore -- Not working
    import tempfile
