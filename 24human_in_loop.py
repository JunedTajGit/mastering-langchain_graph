...
class ApprovalState(TypedDict):
    ...
    draft: str  # what LLM draft to be reviewed
    approved: bool  # it is flag that will be set after human review
    feedback: (
        str  # Feedback provided by human wheather it is yes, or no. Empty initially
    )
    final: str  # Final result.
...
class ReviewState(TypedDict):
    document: str  # initial document to review
    review_comments: list[str]  # review comment after review done
    revision_count: int  # how many times review is done already
    status: str  # current status of the review process
