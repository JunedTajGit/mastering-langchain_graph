...
class ModelRouter:
    ...
    def __init__(self):
        self.cheap_model = AzureChatOpenAI(model="gpt-4o-mini", temperature=0)
        self.expensive_model = AzureChatOpenAI(model="gpt-4o", temperature=0)
        self.classifier = AzureChatOpenAI(model="gpt-4o-mini", temperature=0)
...
class SemanticCache:
    ...
    def __init__(self, similarity_threshold: float = 0.9):
        ...
        self.embedder = AzureChatOpenAI(model="gpt-4o-mini", temperature=0)
...
class CachedLLM:
    ...
    def __init__(self):
        self.llm = AzureChatOpenAI(model="gpt-4o-mini", temperature=0)
